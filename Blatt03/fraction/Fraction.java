...
public class Fraction extends Number {
   ...
   /**
    * returns float value of specified Fraction
    */
   ...
   /**
    * returns int value of specified Fraction by truncating the float value
    */
    public int intValue(){
    ...
    /**
    * returns long value of specified Fraction
    */
...
/*      boolean b = Pattern.matches("-?\\d+/-?[1-9][0-9]\\d*", input);
     int numerator = 0;
     int denominator = 0;
     if (b) {
